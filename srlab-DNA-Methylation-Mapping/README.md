...
-  [**06-nextflow-EMseq**]  - EM-Seq analysis using the nf-core/methylseq pipeline on the Hyak cluster. It involves downloading genome annotation files, transferring pre-processed WGBS data from a remote server, and running the pipeline with Nextflow in EM-Seq mode using a custom configuration, skipping trimming and generating summary reports.
